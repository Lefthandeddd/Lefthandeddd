...
# TODO Красава! единственное что: присмотрись, функция должна возвращать булевое значение, говорящее о том находится точка
#  в окружности или нет. и тогда ты будешь принтить ответ согласно заданию.
